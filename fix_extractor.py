...
with open('app/nlp/extractor.py', 'w', encoding='utf-8') as f:
    f.write(content)

print("Done! Testing import...")
import importlib.util
spec = importlib.util.spec_from_file_location("extractor", "app/nlp/extractor.py")
mod = importlib.util.load_from_spec(spec)
spec.loader.exec_module(mod)
print("extract_all found:", hasattr(mod, 'extract_all'))
print("All good!")
